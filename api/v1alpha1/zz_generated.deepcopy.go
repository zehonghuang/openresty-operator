...
func (in *LocationEntry) DeepCopyInto(out *LocationEntry) {
	*out = *in
	...
	if in.HeadersFromSecret != nil {
		...
		*out = make([]NginxHeaderFromSecret, len(*in))
		copy(*out, *in)
	}
	if in.Timeout != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NginxHeaderFromSecret) DeepCopyInto(out *NginxHeaderFromSecret) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NginxHeaderFromSecret.
func (in *NginxHeaderFromSecret) DeepCopy() *NginxHeaderFromSecret {
	if in == nil {
		return nil
	}
	out := new(NginxHeaderFromSecret)
	in.DeepCopyInto(out)
	return out
}
...
func (in *UpstreamServer) DeepCopyInto(out *UpstreamServer) {
	*out = *in
	...
	if in.NormalizeRequest != nil {
		in, out := &in.NormalizeRequest, &out.NormalizeRequest
		*out = make(map[string]v1.JSON, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
	if in.NormalizeResponse != nil {
		in, out := &in.NormalizeResponse, &out.NormalizeResponse
		*out = make(map[string]v1.JSON, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
